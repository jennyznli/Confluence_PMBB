...
### ALL ANCESTRIES: PHENOTYPE & COVARIATE FILES ### 
library(data.table)

HDIR <- "/project/knathans_tecac/jenny/breast/analysis"
WDIR <- file.path(HDIR, "ALL", "cov")
...
id_file <- file.path(HDIR, "ALL", "step1", "common_snps_qc.id")
eigenvec_file <- file.path(WDIR, "common_snps_qc.eigenvec")
